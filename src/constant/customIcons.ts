...
export const customIcons = {
  ...
  google: {
    path: "M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.6 65.1C321.4 104.9 287.9 92 248 92c-86.5 0-156 70.5-156 156s69.5 156 156 156c99.4 0 136.8-71.3 142.5-108H248v-85.2h236.1c2.2 12.4 3.9 24.9 3.9 40z",
  },
};
