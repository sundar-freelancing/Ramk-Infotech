...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbwyYrM1DWRMzMyQ5a_oJocMGMWlWeSkX6EMgwfttkblAd-JBYRjCxcfBqHyEu_g1ldPVw/exec";
        ...
        return NextResponse.json(
          {
            ...
            details:
              "Please check your Google Apps Script code. The error indicates a column mismatch in the update action.",
          },
          {
            status: 500,
            headers: {
