...
const DashboardLogin = ({ navToSignUp }: { navToSignUp: () => void }) => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (user.userData?.isEmailVerified && user.userData?.role) {
        router.refresh();
        showToast({ message: "Login successful", type: TOAST_TYPES.SUCCESS });
      }
    } catch (err: unknown) {
      const errorMessage =
